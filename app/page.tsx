          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
            <section className="sm:max-w-[19.5rem] md:max-w-[24.5rem] tab:max-w-[28rem] lg:max-w-[30rem]">
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.8, type: "spring", stiffness: 110, delay: 0 }}
              ...
              <motion.p
                ...
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.5, type: "spring", stiffness: 110, delay: 0.1 }}
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.5, type: "spring", stiffness: 110, delay: 0.2 }}
                ...
                <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                  {images.slice(0, 2).map((image, index) => (
                    <motion.div
                      ...
                      viewport={{ once: true }}
                      transition={{ duration: 0.5, type: "spring", stiffness: 110, delay: Math.random() }}
                      key={index}
