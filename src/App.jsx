        ...
        <section>
            <div className="mx-auto max-w-screen-xl px-4 py-20 lg:flex lg:h-screen lg:items-center">
                <div className="mx-auto max-w-xl flex flex-col items-center text-center">
                    <h1 className="font-mono text-[50px] sm:text-[60px] text-white font-light -mt-16">ProjectsHut</h1>
                    <h1 className="leading-3 text-[11px] sm:text-[14px] tracking-widest text-primary">Create & Explore</h1>
                    ...
                    <div className="mt-8 flex flex-wrap justify-center gap-4">
                        ...
                        <a className="group relative inline-block focus:outline-none focus:ring"
                            href="https://github.com/priyankarpal/ProjectsHut/fork" target="_blank">
                            <span
                                className="absolute inset-0 translate-x-1.5 translate-y-1.5 bg-primary transition-transform group-hover:translate-y-0 group-hover:translate-x-0"></span>
                        ...
                        <a className="inline-block  border border-current px-8 py-3 text-sm font-bold text-white tracking-widest uppercase transition hover:scale-110 hover:shadow-xl focus:outline-none focus:ring active:text-primary"
                            href="#projects">
                            Browse
                        </a>
                    </div>
