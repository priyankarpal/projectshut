        ...
        <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
          <div className="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            ...
            <div className="relative mt-16 h-80 lg:mt-8 dev-img-parent-class">
              <img
                className="absolute top-0 left-0 w-[62rem] md:left-[-67px] md:w-[69rem] tab:top-[-11px] tab:w-[62rem] lg:top-[-33px] xl:w-[64rem] max-w-none rounded-md bg-white/5 ring-1 ring-white/10 dev-img-class"
