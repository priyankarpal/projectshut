  ...
  return (
    ...
    (<div className="flex flex-col md:flex-row h-screen my-4">
      <div className="w-full md:w-3/4 mx-2 flex flex-col rounded rounded-md order-2 md:order-1">
        <div className="flex justify-start items-center mb-3 my-5 " style={{
          // border: '2px solid green',
        }}>
          <h3 className="capitalize text-lg/5 font-bold basis-full line-clamp-1 pl-4">
            {'Projects'}
          </h3>
        </div>

        {Object.keys(userObj).length > 0 &&
          (<div className="w-100 min-h-400 my-1" style={{
            // border : '2px solid green',  
            borderRadius: '10px',
            ...
            <div className=' border-b  rounded-lg p-4 relative'>
              <p className='capitalize text-lg/5 font-bold basis-full line-clamp-1 pl-4'>
                {userObj.title}
              </p>
              <p className='line-clamp-1 pr-[.5rem] mb-[1rem] text-[.9rem] my-3 mx-7'>
                {userObj.description}
              </p>
            ...
            <div className=" flex flex-row overflow-auto scrollbar items-center ">
              ...
              <div className="flex flex-wrap">
                {userObj.tech.map((tag, i) => {
                  return (<p className="mb-3 line-clamp-2 my-2 whitespace-normal" key={i}>
                    {tag}
                  </p>)
                })}
              </div>
      ...
      <div className="w-full md:w-1/4 mx-2 flex flex-col shadow-white-md rounded rounded-md order-1 md:order-2 " style={{
        ...
        <div className="flex justify-center items-center mb-3 my-10">
          <img src={`https://github.com/${username}.png`} alt={`${username}'s github profile`} className="w-32 h-32  rounded-full" />
        </div>
