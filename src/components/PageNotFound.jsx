...
const PageNotFound = () => {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center text-white bg-[#000513] p-5">
      <div className="min-h-screen flex flex-col justify-center items-center text-white bg-[#000513]">
        <h1 className="text-6xl font-bold mb-8 animate-bounce">404 - Page Not Found</h1>
        <p className="text-2xl mb-8">
          Oops! Looks like you followed a bad link. If you think this is a mistake, please{" "}
