...
import { ArrowLeftCircle, Copy, Share2, Check, X, Image } from "react-feather";
  ...
  return (
    <section className="flex flex-col gap-4 md:flex-row xsm:my-2 p-4 md:p-8">
      ...
      {!initialLoading && Object.keys(userObj).length > 0 && (
        <div className=" w-full md:w-[50%] md:h-5/6 lg:max-w-[35%] flex flex-col shadow-xl rounded-md mb-4 md:mb-0 md:sticky md:top-2 px-8 ">
